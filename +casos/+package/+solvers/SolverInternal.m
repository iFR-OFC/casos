classdef (Abstract) SolverInternal < casos.package.functions.FunctionInternal
...
methods
    function obj = SolverInternal(name,varargin)
        % Instantiate base class.
        obj@casos.package.functions.FunctionInternal(name,varargin{:});
