classdef test_mrdivide < matlab.unittest.TestCase
    ...
    methods (TestParameterDefinition,Static)
        ...
        function [testValue,refValue] = initializeTestData()
            ...
            load("generateRefValues/refSolutions/refSolution_multipoly_mrdivide.mat")
            testValue = [];
    ...
    methods (Test)
        ...
        function test_mrdivide_single(testCase,testValue,refValue)
            ...
            actSolution = full(poly2basis(mrdivide(testValue(1),2)));
        ...
        function test_mrdivide_multiple(testCase,testValue,refValue)
            ...
            for k = 1:noPoly
                actSolution = [actSolution; full(poly2basis(mrdivide(testValue(k),2)))];
