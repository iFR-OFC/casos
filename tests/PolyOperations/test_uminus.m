classdef test_uminus < matlab.unittest.TestCase
    ...
    methods (TestParameterDefinition,Static)
        ...
        function [testValue,refValue] = initializeTestData()
            ...
            load("generateRefValues/refSolutions/refSolution_multipoly_uminus.mat")
            testValue = [];
    ...
    methods (Test)
        ...
        function test_uminus_single(testCase,testValue,refValue)

            actSolution = full(casadi.DM(poly2basis(uminus(testValue(1)))));
        ...
        function test_uminus_multiple(testCase,testValue,refValue)

            actSolution = [];
            refSolution = [];
            for k = 1:10
                actSolution = [actSolution; full(casadi.DM(poly2basis(uminus(testValue(k)))))];
