classdef test_dot < matlab.unittest.TestCase
    ...
    methods (TestParameterDefinition,Static)
        ...
        function [testValue,refValue] = initializeTestData()
            ...
            load("generateRefValues/refSolutions/refSolution_multipoly_dot.mat")
            testValue = [];
    ...
    methods (Test)
        ...
        function test_dot_single(testCase,testValue,refValue)
            ...
            actSolution  = full(dot(testValue(1),testValue(1)));
        ...
        function test_dot_multiple(testCase,testValue,refValue)
            ...
            for k = 1:length(testValue)/2
                ...
                actSolution = [actSolution; full(dot(testValue(k),testValue(k)))];
