classdef test_rdivide < matlab.unittest.TestCase
    ...
    methods (TestParameterDefinition,Static)
        ...
        function [testValue,refValue] = initializeTestData()
            ...
            load("generateRefValues/refSolutions/refSolution_multipoly_rdivide.mat")
            testValue = [];
    ...
    methods (Test)
        ...
        function test_rdivide_single(testCase,testValue,refValue)
            ...
            actSolution = full(casadi.DM(poly2basis(rdivide(testValue(1), 2))));
        ...
        function test_rdivide_multiple(testCase,testValue,refValue)
            ...
            refSolution = [];
            for k = 1:10
                actSolution = [actSolution; full(casadi.DM(poly2basis(rdivide(testValue(k), 3))))];
