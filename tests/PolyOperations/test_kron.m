classdef test_kron < matlab.unittest.TestCase
    ...
    methods (TestParameterDefinition,Static)
        ...
        function [testValue,refValue] = initializeTestData()
            ...
            load("generateRefValues/refSolutions/refSolution_multipoly_kron.mat")
            testValue = [];
    ...
    methods (Test)
        ...
        function test_kron_single(testCase,testValue,refValue)
            ...
            actSolution = full(poly2basis(kron(testValue(1), testValue(2))));
        ...
        function test_kron_multiple(testCase,testValue,refValue)
            ...
            for k = 1:noPoly
                actSolution = [actSolution; full(poly2basis(kron(testValue(1,k), testValue(2,k))))];
