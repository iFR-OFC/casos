classdef test_prod < matlab.unittest.TestCase
    ...
    methods (TestParameterDefinition,Static)
        ...
        function [testValue,refValue] = initializeTestData()
            ...
            load("generateRefValues/refSolutions/refSolution_multipoly_prod.mat")
            testValue = [];
    ...
    methods (Test)
        ...
        function test_prod_single(testCase,testValue,refValue)
            ...
            actSolution = full(casadi.DM(poly2basis(prod(testValue(1), 1))));
        ...
        function test_prod_multiple(testCase,testValue,refValue)
            ...
            refSolution = [];
            for k = 1:10
                actSolution = [actSolution; full(casadi.DM(poly2basis(prod(testValue(k), 2))))];
