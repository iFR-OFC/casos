classdef test_transpose < matlab.unittest.TestCase
    ...
    methods (TestParameterDefinition,Static)
        ...
        function [testValue,refValue] = initializeTestData()
            ...
            load("generateRefValues/refSolutions/refSolution_multipoly_transpose.mat")
            testValue = [];
    ...
    methods (Test)
        ...
        function test_transpose_single(testCase,testValue,refValue)
            ...
            actSolution = full(casadi.DM(poly2basis(transpose(testValue(1)))));
        ...
        function test_transpose_multiple(testCase,testValue,refValue)
            ...
            refSolution = [];
            for k = 1:10
                actSolution = [actSolution; full(casadi.DM(poly2basis(transpose(testValue(k)))))];
