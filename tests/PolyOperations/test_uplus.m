classdef test_uplus < matlab.unittest.TestCase
    ...
    methods (TestParameterDefinition,Static)
        ...
        function [testValue,refValue] = initializeTestData()
            ...
            load("generateRefValues/refSolutions/refSolution_multipoly_uplus.mat")
            testValue = [];
    ...
    methods (Test)
        ...
        function test_uplus_single(testCase,testValue,refValue)

            actSolution = full(casadi.DM(poly2basis(uplus(testValue(1)))));
        ...
        function test_uplus_multiple(testCase,testValue,refValue)

            actSolution = [];
            refSolution = [];
            for k = 1:10
                actSolution = [actSolution; full(casadi.DM(poly2basis(uplus(testValue(k)))))];
